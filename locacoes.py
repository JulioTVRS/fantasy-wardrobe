...
def AdicionarLocacao(locacoes, clientes, roupas):
    limpar()
...
def RemoverLocacoes(locacoes, clientes, roupas):
    limpar()
...
def AtualizarLocacoes(locacoes, clientes, roupas):
    limpar()
...
def ModuloLocacoes():
    ...
    while resp_locacoes != "0":
        ...
        if resp_locacoes == "1":
            ListarLocacoes(locacoes, clientes, roupas)

        elif resp_locacoes == "2":
            AdicionarLocacao(locacoes, clientes, roupas)

        elif resp_locacoes == "3":
            RemoverLocacoes(locacoes, clientes, roupas)

        elif resp_locacoes == "4":
            AtualizarLocacoes(locacoes, clientes, roupas)